...
namespace bayesopt
{
				     ...
				     double nugget)
  {
    ...
    //std::cout<<"nugget is.................................. "<<nugget<<std::endl;
    //std::cout<<"sample is.................................. "<<nSamples<<std::endl;
	...
	for (size_t jj=0; jj < ii; ++jj)
	  {
	    ...
	    corrMatrix(jj,ii) = corrMatrix(ii,jj);
             /*
             if(ii<10){
               std::cout<<"XX[ii], XX[jj] is "<<XX[ii]<<","<<XX[jj]<<std::endl;
               std::cout<<"corrMatrix(ii,jj) is "<<corrMatrix(ii,jj)<<std::endl;
             }
             */
	  }        
