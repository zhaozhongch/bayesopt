...
const size_t DEFAULT_SLAM_Fail_Threshold= 99999999;
const size_t DEFAULT_RANSAC_Noise       = 0;
...
const std::string His_address          = "/home/zhaozhong/catkin_ws/src/VINS-Mono/RunBayes/Test_random/RT1.csv";//"generate initial points by running program";
...
bopt_params initialize_parameters_to_default(void)
{
  ...
  params.SLAM_Fail_Threshold = DEFAULT_SLAM_Fail_Threshold;
  params.RANSAC_Noise        = DEFAULT_RANSAC_Noise;
  params.his_address         = new char[128];
  strcpy(params.his_address, His_address.c_str());
...
namespace bayesopt {
    ...
    Parameters::Parameters(bopt_params c_params):
        ...
        SLAM_Fail_Threshold  =  c_params.SLAM_Fail_Threshold;  
        RANSAC_Noise         =   c_params.RANSAC_Noise;
        his_address          = std::string(c_params.his_address);
    ...
    bopt_params Parameters::generate_bopt_params()
    {
      ...
      c_params.SLAM_Fail_Threshold =  SLAM_Fail_Threshold;
      c_params.RANSAC_Noise        =  RANSAC_Noise;
      strcpy(c_params.his_address, his_address.c_str());
