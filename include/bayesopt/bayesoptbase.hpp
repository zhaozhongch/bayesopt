...
namespace bayesopt {
  ...
  public:
    ...
    std::vector<double>& get1Dx();
    std::vector<double>& get1Dmean();
    std::vector<double>& get1DStdLowerBound();
    std::vector<double>& get1DStdUpperBound();
    std::vector<double>& get1DAcquisitionFunctionValue();

    std::vector<double>& get2Dx();
    std::vector<std::vector<double> >& get2Dmean();
    std::vector<std::vector<double> >& get2DStdLowerBound();
    std::vector<std::vector<double> >& get2DStdUpperBound();
    std::vector<std::vector<double> >& get2DAcquisitionFunctionValue();

    std::vector<double>& getSampleX();
    std::vector<double>& getSampleY();
  ...
  protected:
    ...
    virtual vectord unremapPoint(const vectord& x) = 0;
  ...
  private:
    ...
    //output surrogate model data and acquisition function data to plot
    std::vector<double> x,y,z,su,sl,c,xx;
    std::vector<std::vector<double> > yy,zz,susu,slsl,cc;
  private:
