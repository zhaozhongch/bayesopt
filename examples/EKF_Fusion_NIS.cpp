...
//g++ EKF_Fusion_NIS.cpp -o EKF_Fusion_NIS -I /usr/include/eigen3  -lceres -lglog -lpthread -fopenmp -lcholmod -lblas -llapack -lbayesopt -lnlopt -lm
...
public:
  ...
  double evaluateSample(const vectord& xin)
  {
    ...
    system("./../../ekf_bayesopt_noupload/applications/kf1/bayes_NIS");
