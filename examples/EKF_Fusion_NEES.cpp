...
//g++ EKF_Fusion_NEES.cpp -o EKF_Fusion_NEES -I /usr/include/eigen3  -lceres -lglog -lpthread -fopenmp -lcholmod -lblas -llapack -lbayesopt -lnlopt -lm
...
public:
  ...
  double evaluateSample(const vectord& xin)
  {
    ...
    system("./../../ekf_bayesopt_noupload/applications/kf1/bayes_NEES");
    ...
    double re = (double)atof(NESS.c_str());
...
// the l_type is not a string variable, so not need "" but the cLCB is. You can see these in parameters.hpp                          
  ...
  //lowerBound(1)=1.0;upperBound(1)=10.0;
