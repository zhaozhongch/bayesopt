...
#include "specialtypes.hpp"// special types  define some data type. If I include this myself, it won't be able to find the file. Just use the original defination.
// for instance, it writes "vectord& xin" in the code, in the special types file, the vectord is boost::numeric::ublas::vector<double>, we can just use that to take the place of vectord in our problem
